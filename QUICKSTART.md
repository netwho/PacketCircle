...
| **Circle / Table** | Switch between visualization and flat table |
...
- **Isolate a conversation**: Click **Select None**, check the pair you want, click **Filter** — Wireshark zooms in on that conversation.
