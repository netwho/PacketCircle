...
setWindowTitle("PacketCircle v.0.4.4"); /* WH: version bump */
...
helpDialog->setWindowTitle("Help - PacketCircle v.0.4.4"); /* WH: version bump */
...
QString("Generated by PacketCircle v.0.4.4 — %1") /* WH: version bump */
                         .arg(QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss")));
