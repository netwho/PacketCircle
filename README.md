...
> **Beta Status**: v0.5.1, fully functional, actively developed. Report issues via [GitHub Issues](https://github.com/netwho/PacketCircle/issues).
...
**Version:**
- `v.0.5.1` (latest, default — just press Enter) — 3-page PDF reports, TCP Window analysis, all protocol info dialogs
- `v.0.4.7` — stable legacy release

**Feature set** (v.0.5.1 only):
...
> The default is v.0.5.1 Standard. Just press Enter twice to install with no prompts.
